...
public class CalcDBHandle {
        ...
        public void insertData(int burden, int perval, String typeval, int totaldiscount, String gugang, 
                        String talgu, String skin, String funeral, String baesang, String c_pid, String c_name) {
