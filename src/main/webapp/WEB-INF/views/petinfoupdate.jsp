					...
					<form class="card" action="petinfoupdatesave" method="post" autocomplete="off" enctype="multipart/form-data">
						<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" name="p_name" class="form-control" value="감자">
							</div>

							<div class="form-group">
								<label class="form-label">견종</label>
								<input type="text" name="p_type" class="form-control" value="말티즈">
							</div>

							<div class="form-group">
								<label class="form-label">생일</label>
								<input type="date" name="p_birth" class="form-control" value="2010-09-08">
							</div>
							...
							<div class="form-footer">
								<button type="submit" class="btn btn-primary btn-block">반려견 정보 수정</button>
								<br>
