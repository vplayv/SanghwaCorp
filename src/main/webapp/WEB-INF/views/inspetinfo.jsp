...
<script>
        ...
        $(function(){
                ...
                $("#callpet").change(function(){
                        ...
                        $.getJSON("selectpetinfo", function(data){
                                alert("호출");
                                $.each(data, (i,v)=>{
                                        type = v.p_type;
                                        alert(s);
...
<!-- <script src="resources/js/petinfojs.js"></script> -->
</head>
<body class="">
	<div class="page">
		<div class="flex-fill">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg order-lg-first">
							<ul class="nav nav-tabs border-0 flex-column flex-lg-row">
								...
								<li class="nav-item dropdown"><a href="javascript:void(0)" class="nav-link active" data-toggle="dropdown">
					...
					<div class="row">
						<div class="col col-login mx-auto">
							<div class="text-center mb-6">
								<img src="/resources/demo/photos/petlogo.jpg" class="h-6" alt="">
							</div>
							<form class="card" action="inscalcmoney" method="POST">
								<div class="card-body p-6">
									...
									<div class="form-group">
										...
										<select name="callpet" id="callpet" class="form-control custom-select" style="width: 205px;">
										...
										<!-- <label class="custom-control custom-checkbox"> <input
                                                                                        ...
                                                                                        class="custom-control-label">반려견 정보 불러오기</span>
                                                                                </label> -->
										<button type="button" class="btn btn-gray" style="margin-left: 10px;" onclick="setpet();">불러오기</button>
									</div>

									<div class="form-footer">
										<button type="submit" class="btn btn-success btn-block">보험료 확인</button>
									</div>
								</div>
							</form>
